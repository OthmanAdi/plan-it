...
- **Initial release.** HTML-first persistent planning skill for Claude Code, with hash-attestation, embedded JSON data layer, and 17 IDE adapter folders shipped on day one.
...
- **11 IDE adapter mirrors**: `.codex/`, `.cursor/`, `.codebuddy/`, `.factory/`, `.mastracode/`, `.opencode/`, `.hermes/`, `.continue/`, `.gemini/`, `.kiro/`, `.pi/`.
